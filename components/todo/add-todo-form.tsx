...
export function AddTodoForm({ onAdd, isPending }: AddTodoFormProps) {
  ...
  return (
    <form
      ...
      className="premium-panel flex flex-col gap-3 rounded-[1.5rem] p-3 sm:flex-row sm:items-center"
    >
      <div className="flex flex-1 items-center gap-2 pl-1">
        ...
        <Input
          ...
          maxLength={120}
        className="h-10 border-0 bg-transparent px-1 shadow-none focus-visible:bg-transparent"
        />
      </div>
